...
DIRECT_WORKER_MODE="${DIRECT_WORKER_MODE:-true}"
WORKER_REQUEST_TIMEOUT_MS="${WORKER_REQUEST_TIMEOUT_MS:-240000}"
ALLOWED_ORIGINS="${ALLOWED_ORIGINS:-https://lottoforunluckypeople.netlify.app}"
PURCHASE_JOB_NAME="${PURCHASE_JOB_NAME:-}"
PURCHASE_CALLBACK_URL="${PURCHASE_CALLBACK_URL:-}"
